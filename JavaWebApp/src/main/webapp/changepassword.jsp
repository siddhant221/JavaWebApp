...
<td><input type="text" id="cpass" name="cpass" required></td>
</tr>
<tr>
<th>New Password</th>
<td><input type="text" id="npass" name="npass" required></td>
</tr>
<tr>
<th>Confirm Password</th>
<td><input type="text" id="confpass" name="confpass" required></td>
</tr>
...
$.post("passwordchange.jsp",{cpass:cpass,npass:npass,confpass:confpass},function(data){
	alert(data);
	$("#cpass").val('');
	$("#npass").val('');
	$("#confpass").val('');

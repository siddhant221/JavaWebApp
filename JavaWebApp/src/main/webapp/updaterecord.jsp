...
<tr>
<th></th>
<td><input type="button" id="btn" value="UPDATE BOOK" /></td>
</tr>
</table>
<!-- </form> -->
</center>
...
$.post("updatebook.jsp",{bookname:bookname,bookISBNnum:bookISBNnum,author:author,yearOFRelease:yearOFRelease,publisher:publisher},function(data){
	alert(data);
	$("#bookname").val('');
	$("#bookISBNnum").val('');
	$("#author").val('');
